export const TEXT_TO_REMOVE=[
    ...
    "Notice :Please kindly check your car model and make sure the model fits in case of buying the wrong product."
  ]

  export const DESCRIPTION_TITLE_KEY_WORDS = [
    "Specifications :",
    "Item Description:"
    // "Package Including :",
    // "Note :",
  ...
  export const MINIMUM_DESCRIPTION_LENGTH  = 30
